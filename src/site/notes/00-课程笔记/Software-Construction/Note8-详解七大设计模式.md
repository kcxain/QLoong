---
{"dg-publish":true,"permalink":"/00-课程笔记/Software-Construction/Note8-详解七大设计模式/","title":"Note8- 详解七大设计模式"}
---
...
![](https://kkcx.oss-cn-beijing.aliyuncs.com/img/v2-4f93a69a370d9f6548d905ae4baa9fa8_720w.webp)
...
![](https://kkcx.oss-cn-beijing.aliyuncs.com/img/v2-e8042bad081b30ed18cff74bdc7b571e_720w.webp)

适配器可以用两种形式实现：**继承**(Inheritance) 和**委托**(Delegation)

![](https://kkcx.oss-cn-beijing.aliyuncs.com/img/v2-7818c80ae7d38f7be02fdf93665b1351_720w.webp)
...
![](https://kkcx.oss-cn-beijing.aliyuncs.com/img/v2-89a60071783bb1d2aa3c8a9ee23e95c6_720w.webp)
...
![](https://kkcx.oss-cn-beijing.aliyuncs.com/img/v2-fcf9416316eff5f46ef6bdb16ddc58f1_720w.webp)
...
![](https://kkcx.oss-cn-beijing.aliyuncs.com/img/v2-24c9308538358296367315700dd9e838_720w.webp)

这样不仅会使继承树变得很深，还会在子类中多次实现相同的功能，有大量的**代码重复**

这时就能用装饰器模式解决问题：

![](https://kkcx.oss-cn-beijing.aliyuncs.com/img/v2-6b94bd6c27b38a02ab49f83dc7cb5f8e_720w.webp)
...
![](https://kkcx.oss-cn-beijing.aliyuncs.com/img/v2-6ba99b81026c80d1f913f9b291da63e8_720w.webp)
...
![](https://kkcx.oss-cn-beijing.aliyuncs.com/img/v2-3a67e1f4c8ca2b541a65c5a951dcc51e_720w.webp)

比如从不同类型的文件中进行读操作，对于不同文件，这个操作的步骤相同，但是具体实现不同

![](https://kkcx.oss-cn-beijing.aliyuncs.com/img/v2-9c54c5f75d3960e2ea006d6ef08e0529_720w.webp)
...
![](https://kkcx.oss-cn-beijing.aliyuncs.com/img/v2-c7ec0ab452b4dc4397f74fc0c34fa875_720w.webp)
...
![](https://kkcx.oss-cn-beijing.aliyuncs.com/img/v2-06967bc3caf63f0c90b26c0a442892e3_720w.webp)
...
![](https://kkcx.oss-cn-beijing.aliyuncs.com/img/v2-225e5ff2e899e1c4ffec52ffa7606588_720w.webp)
...
- Visitor 强调的是外部定义某种对 ADT 的操作，该操作与 ADT 自身关系不大（只是访问 ADT），故 ADT 内部只需要开放 `accept(visitor)` 即可，客户端通过它设定 `visitor` 操作并在外部调用
- Strategy 则强调是对 ADT 内部某些要实现的功能的相应算法的灵活替换。这些算法是 ADT 功能的重要组成部分，只不过是**委托**到外部 `strategy` 类而已
...
![](https://kkcx.oss-cn-beijing.aliyuncs.com/img/v2-6a5253cf2f3d92e29c78720dd29de1a8_720w.webp)

比如，**适配器模式**(Adaptor)

![](https://kkcx.oss-cn-beijing.aliyuncs.com/img/v2-05bf6af500333a986145b6a212e5a775_720w.webp)
...
![](https://kkcx.oss-cn-beijing.aliyuncs.com/img/v2-83b88ff8508d3d41ce843bf9073e2011_720w.webp)
...
![](https://kkcx.oss-cn-beijing.aliyuncs.com/img/v2-40537a948a35f558265514eee911a394_720w.webp)

比如，**策略模式**(Strategy)

![](https://kkcx.oss-cn-beijing.aliyuncs.com/img/v2-07be5f84fafe70ed0614891c764b9106_720w.webp)

根据 OCP 原则，想有多个算法的实现，在右侧树里扩展子类型即可，在左侧子类型里传入不同的类型实例

**迭代器模式**(Iterator)

![](https://kkcx.oss-cn-beijing.aliyuncs.com/img/v2-6d9971cf95295743a7bc0fcf438640d0_720w.webp)

**工厂方法模式**(Factory Method)

![](https://kkcx.oss-cn-beijing.aliyuncs.com/img/v2-f593af4bb7517e40fa79a10abce8bb67_720w.webp)

左右两棵树的子类型一一对应，如果工厂方法里使用 `Type` 表征右侧的子类型，那么左侧的子类型只要 1 个即可

**访问者模式**(Visitor)

![](https://kkcx.oss-cn-beijing.aliyuncs.com/img/v2-d42eb5a4a40c71a3c573994042dec27a_720w.webp)
